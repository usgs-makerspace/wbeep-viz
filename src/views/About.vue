    ...
    <div id="aboutContent">
      ...
      >
        ...
        <p>
          ...
          </router-link> displays a near real-time indicator of daily-average water temperature 
          ...
          <a
            ...
            target="_blank"
            @click="runGoogleAnalytics('About Page', 'click', 'clicked Precipitation-Runoff Modeling System (PRMS)')"
          >
      ...
      >
        ...
        >
        <p>
          Third, the <router-link to="/water-use">
            National water use application
          </router-link> provides a consistent national source of water use data.  
          ...
          <a
            ...
            target="_blank"
            @click="runGoogleAnalytics('About Page', 'click', 'clicked Dieter and others, 2018')"
          >
      ...
      >
        ...
        <p>
          ...
          <a
            ...
            target="_blank"
            @click="runGoogleAnalytics('About Page', 'click', 'clicked Bock et. al, 2020')"
          > 
            (Bock et. al, 2020),
        ...
        <p>
          ...
          <a
            ...
            target="_blank"
            @click="runGoogleAnalytics('About Page', 'click', 'clicked Abatzoglou, 2013')"
          > 
            (Abatzoglou, 2013) 
          </a>
